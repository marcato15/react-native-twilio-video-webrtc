...
/// participlants
@objc public protocol StandardVideoSource {
    /// Content hint for downstream processing.
    var videoContentHint: StandardVideoContentHint { get set }
